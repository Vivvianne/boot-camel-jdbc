...
public class EmployeeController {
	...
	@RequestMapping(value = "/employees/external", method = RequestMethod.GET)
	public List<Employee> getAllEmployeesFromExternal() {
		List<Employee> employees = producerTemplate.requestBody("direct:test", null, List.class);
		return employees;
	}
